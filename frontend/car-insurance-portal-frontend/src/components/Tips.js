  ...
  return (
    <div>
      ...
      <div className="title-section">
        <p className="rapidInsure-title_2">
          Tips For Better Auto Insurance
        </p>
        <img className="thumbnail1" src={Highway} alt=""/>
      </div>
      ...
      <div className="insurance-body">
        ...
        <ul className="bullet-requirements">
      ...
      <div className="insurance-tip1">
        <p className="tip1-title">
          1. Compare Insurance Quotes
        </p>

        <p className="tip1-body">
      ...
      <div className="insurance-tip2">
        <p className="tip2-title">
          2. Increase Your Deductible
        </p>

        <p className="tip2-body">
      ...
      <div className="insurance-tip3">
        <p className="tip3-title">
          3. Maintain A Good Credit History
        </p>

        <p className="tip3-body">
      ...
      <div className="insurance-tip4">
        <p className="tip4-title">
          4. Keep A Clean Driving Record
        </p>

        <p className="tip4-body">
