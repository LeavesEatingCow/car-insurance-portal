...
const Welcome = () =>{
    return(
        <div className="home-container">
            <Navbar/>
            <header>
                <img src={HeaderImg} alt="Welcome to RapidInsure" className="banner" />
                <div class="centered">
            ...
            <article className="key-points">
                <p>At RapidInsure, we streamline the process of finding the best car insurance for your needs. Our platform is designed to make insurance inquiries as straightforward and efficient as possible. Say goodbye to the hassle of reaching out to multiple insurers one by one!</p>
